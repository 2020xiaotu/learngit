...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" title="HuiZi" />
                <tabs id="tabs" />
            </appbar>
            <viewpager id="viewpager">
                <frame>
                    ...
                    <vertical>
                    <button id="amsw" text="阅读模式选择" layout_gravity="center" w="auto" h="auto" circle="true"/>
                    <text textSize="16sp" textColor="red" text="HuiZi.apk version:1.1.4 " />
                    <text textSize="16sp" textColor="red" text="新增了更新题库的功能, 理论上不用再去刷挑战答题试错,直接更新网络题库就行(由于网络题库的不稳定性,可能会更新到错误的答案,题库具体要怎么更新看你自己喜欢哪种)" />
                    </vertical>
